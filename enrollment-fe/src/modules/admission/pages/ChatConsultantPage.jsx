...
function makeSessionId() {
  ...
  // crypto.randomUUID() requires a secure context (HTTPS/localhost) — falls back
  // to a manual UUID v4 via crypto.getRandomValues(), which works over plain HTTP
  // too. Backend requires sessionId to be UUID-shaped (@IsUUID()).
